"""
Run recursive character chunking experiment
...
from chunking import split_text_recursive
...
def main():
    ...
    podcast_chunks = split_text_recursive(podcast_text, **PODCAST_SETTINGS)
    pdf_chunks = split_text_recursive(pdf_text, **PDF_SETTINGS)


    # Evaluate chunking results
    print_chunk_statistics("Podcast recursive chunks", podcast_chunks)
    print_chunk_statistics("PDF recursive chunks", pdf_chunks)
